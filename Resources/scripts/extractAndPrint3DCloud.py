...
def extraer_bloques_y_guardar(input_file, output_prefix="LidarSample_"):
    ...
    start_marker= "SystemTasks::image3dCapturerTask START_FRAME"
    end_marker = "SystemTasks::image3dCapturerTask END_FRAME"
    #end_marker = "[DEBUG] SystemTasks::image3dCapturerTask executed"
    block_lines = []
    capturing = False
    count = 0

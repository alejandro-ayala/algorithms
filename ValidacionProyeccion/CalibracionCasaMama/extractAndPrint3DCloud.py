...
def extraer_bloques_y_guardar(input_file, output_prefix="LidarSample_"):
    start_marker = "[DEBUG] 3D image captured started"
    end_marker = "[DEBUG] 3D image captured end"
    block_lines = []
    capturing = False
    count = 0
...
if __name__ == "__main__":
    archivo_log = "Lidar.log"  # Cambia esto si el nombre de tu archivo es diferente
